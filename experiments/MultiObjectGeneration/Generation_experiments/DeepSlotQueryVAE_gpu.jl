...
for slot in active_slots
    ...
    println("slot $slot -> closest ground truth: class $closest_gt_class (gt position $closest_gt) | L2 dist $(round(gt_dists[closest_gt]; digits=3)) | probability of existence $(round(σ(logits_dup[1, slot, 1]); digits=2))")
end
