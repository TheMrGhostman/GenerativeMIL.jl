...
using GenerativeMIL
using Zygote
using GenerativeMIL.Models: check, loss, unpack_mill, loss_gradient, loss_ema, vqvae_constructor_from_named_tuple
...
# construct model
modelname = "VQVAE"
model = vqvae_constructor_from_named_tuple(;idim=3, parameters...);
