...
using GenerativeMIL
using Zygote
using GenerativeMIL.Models: check, loss, unpack_mill, loss_gradient, loss_ema, vgq_poolae_constructor_from_named_tuple
...
# construct model
modelname = "VGQ_PoolAE"
model = vgq_poolae_constructor_from_named_tuple(;idim=3, parameters...);

# loss function
loss_f = loss_ema # no other choice for now 
